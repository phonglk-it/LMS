...
export default function StudentUserPage() {
  ...
  if (loading) return (
    <div className="flex flex-col justify-center items-center h-[60vh] gap-4">
      ...
      <p className="text-gray-500 font-medium italic">Loading student profile...</p>
    </div>
  );

  if (!user) return <div className="p-6 text-center text-black">User not found</div>;
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-8 animate-in fade-in duration-500 text-black">
      ...
      <div className="mb-8 text-center md:text-left">
        ...
        <p className="text-gray-500 text-xs md:text-base italic font-medium">Manage your personal information and learning account.</p>
      </div>
      ...
      <div className="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/3 bg-blue-50/30 p-6 md:p-10 flex flex-col items-center border-b lg:border-b-0 lg:border-r border-gray-100">
            ...
            <div className="mt-6 md:mt-8 w-full space-y-4 text-center">
              <div>
                ...
                <p className="text-xs md:text-sm font-bold text-gray-600 italic px-2 truncate">
                  {avatarFile ? `Ready: ${avatarFile.name}` : "Student Identity Active"}
                </p>
              </div>
          ...
          <div className="w-full lg:w-2/3 p-6 md:p-10 space-y-4 md:space-y-6">
            <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] mb-2 md:mb-4">Personal Details</h3>
            ...
            <div className="grid grid-cols-1 gap-3 md:gap-4">
              ...
              <div className="group flex items-center gap-4 md:gap-5 p-4 md:p-5 rounded-2xl md:rounded-[1.5rem] bg-white border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all duration-300">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[9px] md:text-[10px] font-black text-gray-400 uppercase tracking-wider">Account Type</p>
                  <div className="flex items-center gap-2">
                    <p className="text-sm md:text-lg font-bold text-gray-800 uppercase tracking-tighter">{user.role}</p>
                    <span className="px-1.5 py-0.5 bg-green-100 text-green-600 text-[8px] md:text-[10px] font-black rounded-md uppercase">Verified Student</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 md:pt-6">
              <button
                onClick={() => window.location.href = `/student/profile/change-password`}
                className="flex items-center justify-center gap-3 w-full md:w-auto px-6 md:px-8 py-3.5 md:py-4 bg-slate-900 text-white rounded-xl md:rounded-[1.5rem] font-black uppercase text-[11px] md:text-sm hover:bg-slate-800 transform active:scale-95 transition-all shadow-xl shadow-slate-200"
              >
      ...
      <div className="mt-8 text-center">
        <p className="text-[9px] md:text-[10px] text-gray-400 font-bold uppercase tracking-[0.2em]">EduRio Learning Protocol v2.0</p>
      </div>
    </div>
  );
}