  ...
  if (!selectedLesson) return (
    <div className="flex flex-col items-center justify-center h-screen gap-6 px-4 text-center bg-gray-50">
      <div className="p-6 bg-white rounded-3xl shadow-sm border border-gray-100">
        ...
        <Link href={`/admin/courses/${id}/lessons/create`} className="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-100">
    ...
    <div className="flex flex-col lg:flex-row h-screen bg-white overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col h-full overflow-y-auto overflow-x-hidden">
        ...
        <div className="flex items-center justify-between px-4 sm:px-8 py-4 border-b sticky top-0 bg-white/90 backdrop-blur-md z-30 shadow-sm">
          <Link href="/admin/courses" className="flex items-center text-gray-500 hover:text-blue-600 transition-colors text-[10px] sm:text-xs font-black uppercase tracking-widest">
        ...
        <div className="p-4 sm:p-8 w-full">
          ...
          {selectedLesson.videoUrl ? (
            ...
            <div className="aspect-video w-full rounded-3xl bg-gray-50 flex flex-col items-center justify-center mb-8 border-2 border-dashed border-gray-200">
              ...
              <p className="text-gray-400 font-bold uppercase text-[10px] tracking-widest">No video provided</p>
            </div>
          )}
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-8">
            ...
            <div className="flex gap-2 shrink-0">
              <Link 
                href={`/admin/courses/${id}/lessons/${selectedLesson.id}/edit`} 
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs font-medium">Downloadable PDF document</p>
                  </div>
                </div>
                <a 
      ...
      `}>
        ...
        <div className="p-6 border-b bg-white flex justify-between items-center sticky top-0 z-10">
          ...
          <div className="flex items-center gap-2">
            <Link 
              href={`/admin/courses/${id}/lessons/create`} 
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-gray-900/80 backdrop-blur-sm p-4">
          <div className="bg-white rounded-[32px] p-8 max-w-sm w-full shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <div className="flex flex-col gap-3">
              <button onClick={handleDelete} className="w-full py-4 rounded-2xl font-black uppercase text-xs tracking-widest bg-red-600 text-white hover:bg-red-700 transition-all shadow-lg shadow-red-200">
                Yes, Delete Lesson
              </button>
              <button onClick={() => setIsDeleteModalOpen(false)} className="w-full py-4 rounded-2xl font-bold text-gray-500 hover:bg-gray-100 transition-colors text-xs uppercase tracking-widest">
                Cancel
              </button>
            </div>
          </div>
